...
const VerdictSection: React.FC<Props> = ({ verdict }) => {
  const confidence = Math.max(0, Math.min(1, verdict.confidenceLevel));
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          <h2 className="text-xl font-bold text-slate-800">Cross Lens Synthesis</h2>
          <p className="text-sm text-slate-500 mt-1">Model generated synthesis, not a professional or peer reviewed verdict.</p>
        </div>
      </div>
          ...
          <div className="space-y-6">
            <section>
              <div className="flex items-center gap-2 mb-2 text-slate-500">
                ...
                <h4 className="text-xs font-bold uppercase tracking-widest">Evidence Summary</h4>
              </div>
            ...
            <section>
              <div className="flex items-center gap-2 mb-2 text-slate-500">
                ...
                <h4 className="text-xs font-bold uppercase tracking-widest">Economic and Adoption Factors</h4>
              </div>
            ...
            <section>
              <div className="flex items-center gap-2 mb-2 text-slate-500">
                ...
                <h4 className="text-xs font-bold uppercase tracking-widest">Ethics and Governance</h4>
              </div>
            ...
            <section className="bg-indigo-900 text-white p-6 rounded-xl relative overflow-hidden">
              <div className="relative z-10">
                ...
                <div className="flex items-end gap-2">
                  <span className="text-5xl font-bold leading-none">{confidencePct}%</span>
                  <span className="text-xs mb-1 opacity-60 font-mono">self reported score</span>
                </div>
                <div className="w-full bg-white/20 h-2 rounded-full mt-4 overflow-hidden">
                  <div className="bg-indigo-400 h-full transition-all duration-1000" style={{ width: `${confidencePct}%` }} />
                </div>
                <p className="text-[11px] opacity-60 mt-3 leading-relaxed">This is generated by the model. It is not a calibrated probability of correctness.</p>
              </div>
